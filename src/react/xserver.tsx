...
//
// import importers from "virtual:reacticajs:api-imports";
// import * as commonHooks from "virtual:reacticajs:common-hooks";
// import {
//     RawRequest,
//     PageRenderOptions,
//     ReacticaRequestBodyAndType,
//     CommonHooks,
//     ServePageHook,
// } from "./lib/types";
...
export async function generateResponse(
    ...
    //             return async (req: ReacticaRequest) => {
    ...
    //             saveResponse &&
    //             (response.prerender ??
    //                 (REACTICA_BUILD_TARGET === "static" && response.status !== 404))
    //         ) {
    ...
    //     if (prerendering || !REACTICA_DETECT_LOCALE) {
    //         return REACTICA_DEFAULT_LOCALE;
    //     }
    //
    ...
    //
    //     if (REACTICA_DETECT_LOCALE && result.redirect) {
    //         if (prerendering) {
    //             return {
    //                 status: 300,
    //                 headers: { "x-reactica-prerender": "language-redirect" },
    ...
    const serverHooks = {};//await import("virtual:reacticajs:server-hooks");
    const { servePage = (req: any, render: any) => render(req) } = serverHooks as {
        servePage: any | undefined;
    };
    ...
    async function render(
        ...
        // let app = (
        //     <StrictMode>
        //         <StaticRouter location={request.url.pathname} context={{}}>
        ...
        let app = (
            <SSRMode location={request.url.pathname} context={helmetContext} >
        ...
        // head += `<script>[$reactica$rootContext,$reactica$rendered]=${dataScript}</script>`;
        //
        // if (pageRoutes) {
        //     head += `<script>$reactica$routes=(0,eval)(${devalue(
        //         pageRoutes,
        //     )})</script>`;
        // }
        ...
        //     headers["x-reactica-prerender"] = "no-crawl";
        // }
        //
