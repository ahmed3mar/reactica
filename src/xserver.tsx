...
export async function generateResponse(
    ...
    let locale = REACTICA_DEFAULT_LOCALE;
    ...
    async function render(
        ...
        if (!stack) {
            const html = htmlPlaceholder.replace(
                "<!-- reactica-context-placeholder -->",
                `<script>$reactica$rootContext=${devalue(context)}</script>`,
            );
            ...
            if (REACTICA_BUILD_TARGET === "static" && prerendering && saveResponse) {
