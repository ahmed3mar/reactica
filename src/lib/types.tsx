...
interface ReacticaRequestBase<C = Record<string, unknown>>
...
export type ReacticaRequestBodyAndType =
    | EmptyBody
    | TextBody
    | BinaryBody
    | FormDataBody
...
export type RawRequest = RawRequestBase & ReacticaRequestBodyAndType;
export type ReacticaRequest<C = Record<string, unknown>> = ReacticaRequestBase<C> &
    ReacticaRequestBodyAndType;

export interface ReacticaResponse {
    status?: number;
    headers?:
...
export type RequestHandler = (
    request: ReacticaRequest,
) => ReacticaResponse | Promise<ReacticaResponse>;

export type ReacticaMiddleware = (
    request: ReacticaRequest,
    next: (request: ReacticaRequest) => Promise<ReacticaResponse>,
) => ReacticaResponse | Promise<ReacticaResponse>;
...
export interface ClientHooks {
    /** Do initialization work before hydration. If you return a promise, Reactica will delay hydration until it resolves */
