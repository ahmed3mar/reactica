...
export async function reacticaVitePlugin(
    ...
    const PAGES = `/${pagesDir}/**/(*.)(${componentExtensions})`;
    ...
    // console.log('pageRoutesContent', pageRoutesContent)
    ...
    const virtualModules = virtual({
        ...
        "virtual:reacticajs:page-routes": pageRoutesContent,
        "virtual:reacticajs:api-routes": apiRoutesContent,
    });
